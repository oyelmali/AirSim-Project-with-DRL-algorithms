...
from lib.discreteEnvironment import DroneEnvironment
...
initial_collect_steps = 5000 # rastgele bir ilkeyle toplanan toplam adım sayısı. TimeLimit adımlarına her ulaşıldığında, ortam sıfırlanır
...
train_checkpointer = common.Checkpointer(ckpt_dir=checkpoint_dir, max_to_keep=1, agent=agent, policy=agent.policy, replay_buffer=replay_buffer, global_step=train_step_counter)
